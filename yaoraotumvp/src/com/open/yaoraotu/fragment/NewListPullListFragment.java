 ...
 *****************************************************************************************************************************************************************************
 */
public class NewListPullListFragment extends CommonPullToRefreashListMVPFragment2<MasonryBean, MasonryJson, CommonPresenter, NewListAdapter>
implements CommonView<MasonryJson, CommonPresenter>
{
	public static NewListPullListFragment newInstance(boolean isVisibleToUser) {
		NewListPullListFragment fragment = new NewListPullListFragment();
