 ...
 *****************************************************************************************************************************************************************************
 */
public class TopThemePullGridPresenterImpl extends CommonAsyncTaskPresenter2<MasonryJson,CommonPresenter,CommonView<MasonryJson,CommonPresenter>>  {
	public TopThemePullGridPresenterImpl(Context context, @NonNull CommonView view,String url) {
	...
	public MasonryJson call() throws Exception {
		...
		String typename = "YaoRaoTuJsoupService-getTopTheme-"+pageNo;
		if(NetWorkUtils.isNetworkAvailable(mContext)){
//			mMArticleJson.setList(YaoRaoTuJsoupService.getPliList(href, pageNo));
			mMArticleJson.setList(YaoRaoTuJsoupService.getTopTheme(href, pageNo));
			try {
				//数据存储
				Gson gson = new Gson();
