...
import com.open.yaoraotu.adapter.ImageAdapter;
 ...
 ***************************************************************************************************************************************************************************** 
 */
public class ImagePullListHeadFootFragment extends CommonPullToRefreashListMVPFragment2<MasonryBean, MasonryJson, CommonPresenter,ImageAdapter> 
implements CommonView<MasonryJson, CommonPresenter> {
	
	public static ImagePullListHeadFootFragment newInstance(boolean isVisibleToUser) {
		ImagePullListHeadFootFragment fragment = new ImagePullListHeadFootFragment();
