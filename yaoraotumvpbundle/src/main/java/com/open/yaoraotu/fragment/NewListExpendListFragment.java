 ...
 ***************************************************************************************************************************************************************************** 
 */
public class NewListExpendListFragment extends CommonExpendListMVPFragment<MasonryBean, MasonryJson, CommonPresenter, NewListAdapter> {
	public static NewListExpendListFragment newInstance(boolean isVisibleToUser) {
		NewListExpendListFragment fragment = new NewListExpendListFragment();
