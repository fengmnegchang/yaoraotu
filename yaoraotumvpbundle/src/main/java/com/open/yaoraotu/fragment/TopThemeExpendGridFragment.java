 ...
 ***************************************************************************************************************************************************************************** 
 */
public class TopThemeExpendGridFragment extends CommonExpendGridMVPFragment<MasonryBean, MasonryJson, CommonPresenter, NewListAdapter> {

	public static TopThemeExpendGridFragment newInstance(boolean isVisibleToUser) {
		TopThemeExpendGridFragment fragment = new TopThemeExpendGridFragment();
