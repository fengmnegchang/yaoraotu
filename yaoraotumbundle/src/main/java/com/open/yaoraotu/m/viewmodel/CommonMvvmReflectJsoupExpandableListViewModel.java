 ...
 * @description: ****************************************************************************************************************************************************************************
 */
public class CommonMvvmReflectJsoupExpandableListViewModel extends MVVMCommonViewModel<MasonryGroupJson> {
    public ObservableList<MasonryGroupBean> items = new ObservableArrayList<MasonryGroupBean>();

    public CommonMvvmReflectJsoupExpandableListViewModel(Context mContext, String methodName) {
        this(mContext,null,methodName,null,null);
    }

    public CommonMvvmReflectJsoupExpandableListViewModel(Context mContext, String className, String methodName, Class[] parameterTypes, Object[] args) {
        super(mContext);
